Write a script to simulate the rolling of two dice. The script should use Math.random to roll the first die and use it again to roll the second die. The sum of the two values should then be calculated.  
